...
//           const valuesToCheck = [
//             12, 15, 20, 30, 35, 50, 65, 70, 75, 80, 90, 100,
//           ];
...
//           stderrData += data.toString(); // Collect error output
//         });
...
//               reject(
//                 new Error(
//                   `Python process exited with non-zero code: ${code}.Error output: ${stderrData}`
//                 )
//               );
//             }
//           });
